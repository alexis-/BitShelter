...
/// <summary>
/// Credit : http://mel-green.com/2010/01/progressstream/
/// </summary>
namespace MyPreciousData.IO
{
  /// <summary>
  ...
  public class ProgressStream : Stream
  {
    ...
    protected ProgressStreamReportEventArgs CreateEventArgs(int bytesMoved, bool isRead)
    {
      return new ProgressStreamReportEventArgs(
        bytesMoved,
        innerStream.CanSeek ? innerStream.Length : -1,
        innerStream.CanSeek ? innerStream.Position : -1,
        isRead);
    }
    ...
    protected virtual void OnBytesRead(int bytesMoved)
    {
      if (BytesRead != null)
      {
        var args = CreateEventArgs(bytesMoved, true);
        BytesRead(this, args);
      }
    }
    ...
    protected virtual void OnBytesWritten(int bytesMoved)
    {
      ...
      {
        var args = CreateEventArgs(bytesMoved, false);
    ...
    protected virtual void OnBytesMoved(int bytesMoved, bool isRead)
    {
      if (BytesMoved != null)
      {
        var args = CreateEventArgs(bytesMoved, isRead);
